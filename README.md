...
python main_mt.py test_dpi.pcap output.pcap --block-app YouTube --lbs 2 --fps 2
...
If you have questions about any part of this project, the code is well-commented and follows the same flow described in this document. Start with the simple version (`main_simple.py`) to understand the concepts, then move to the multi-threaded version (`main_mt.py`) to see how parallelism is added.
